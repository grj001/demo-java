package com.grj.javatest.awing;
...
public class TestGUI {
	...
	public static void test02() throws InterruptedException {
		...
		// 根据图片创建ImageIcon对象
		ImageIcon i = new ImageIcon("src/main/java/com/grj/javatest/awing/1.png");
		// 设置ImageIcon
		l.setIcon(i);
	...
	/**
	 * 6 按钮组 ButtonGroup 对按钮进行分组，把不同的按钮， 放在同一个分组里 ，同一时间，只有一个 按钮 会被选中
	 */
	...
	/**
	 * 7 下拉框 JComboBox 下拉框 使用getSelectedItem来获取被选中项 使用setSelectedItem() 来指定要选中项
	 */
	public static void test07() {
		...
		JComboBox<Object> cb = new JComboBox<Object>(heros);
	...
	/*
	 * 9 文本框 JTextField 输入框 setText 设置文本 getText 获取文本 JTextField
	...
	// JPasswordField 密码框
	// 与文本框不同，获取密码框里的内容，
	// 推荐使用getPassword，该方法会返回一个字符数组，而非字符串
	...
	public static void testContentPanel(String[] args) {
	...
	public static void testSplitPanel(String[] args) {
	...
	public static void testJScrollPanel() {
	...
	// 5 TabbedPanel
	public static void testTabbedPanel(String[] args) {
